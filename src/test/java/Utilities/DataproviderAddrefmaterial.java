...
public class DataproviderAddrefmaterial {
	@DataProvider(name="testAddrefmaterial",indices= {0})
	public String[][] getData() throws IOException {
	    String path = System.getProperty("user.dir")+"\\TestData\\TestDataAddrefmaterial.xlsx"; //taking Excel file from testData
